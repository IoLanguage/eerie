...
h3. Planned features
  ...
  * Ability to locally patch packages, _a la_ "BSD Ports":http://www.freebsd.org/ports/index.html ("see also":http://networking.ringofsaturn.com/Unix/createportpatch.php)
  * Run tests
  * Generate documentation
  * Optional central repository (or repositiores, like "Ruby Gems":http://rubygems.org/)
